...
/**
 * Defines the mail back-compatibility plug-in for contact module.
 *
 * @MailBc(
 *   id = "contact",
 *   label = @Translation("Mail BC for contact module"),
 * )
 */
class ContactMailBc implements MailBcInterface {
